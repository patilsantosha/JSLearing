...
console.log('=================================================');
console.log("First character after trim:==>", strtrim.charAt(0),"Last character after trim:==>",strtrim.charAt(33));
console.log('=================================================');
...
console.log(`substring starting from Index "22" is ==>`, strtrim.substring(22));
console.log('=================================================');
